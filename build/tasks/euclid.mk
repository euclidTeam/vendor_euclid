...
EUCLID_TARGET_PACKAGE := $(PRODUCT_OUT)/euclid-$(EUCLID_VERSION).zip
...
$(EUCLID_TARGET_PACKAGE): $(INTERNAL_OTA_PACKAGE_TARGET)
	...
	$(hide) ./vendor/euclid/build/tools/generate_json_build_info.sh $(TARGET_DEVICE) $(PRODUCT_OUT) $(EUCLID_TARGET_PACKAGE)
